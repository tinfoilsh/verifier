...
//go:generate go run ../rootfetch/main.go -o ../wasm/trusted_root.json
	...
	return js.FuncOf(func(this js.Value, args []js.Value) interface{} {
		handler := js.FuncOf(func(_ js.Value, promiseArgs []js.Value) interface{} {
			...
			go func() {
				...
				measurement, err := sigstore.VerifyAttestation(trustedRootJSON, bundleJSON, repo, digest)
				if err != nil {
					reject.Invoke(err.Error())
					return
				}
		...
		handler := js.FuncOf(func(_ js.Value, promiseArgs []js.Value) interface{} {
			...
			go func() {
				...
				result := map[string]interface{}{
					...
					"certificate":     verification.TLSPublicKeyFP, // Fallback for backwards compatibility
